...
export function AiRunNotice() {
  ...
  return (
    <div
      role="status"
      className="fixed bottom-4 right-4 lg:bottom-4 lg:right-6 z-[9998] flex max-w-[min(calc(100vw-2rem),24rem)] items-start gap-3 rounded-xl border border-outline-variant bg-surface-container-high p-3 shadow-panel"
    >
