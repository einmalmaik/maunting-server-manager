...
function DialogInhalt({
  ...
  return (
    <DialogContent className="max-w-md w-full bg-surface-container border border-outline-variant/40 shadow-xl rounded-2xl p-5 space-y-4">
      ...
      {/* `px-0`, damit die Fusszeile die Breite des Fensterinhalts hat, und
          `flex-wrap`, damit sie auf einem 375-px-Telefon umbricht statt
          „Übernehmen" über den Rand zu schieben — genau das tat sie vorher. */}
      <DialogFooter className="flex flex-wrap items-center justify-between gap-2 px-0 pt-3 border-t border-outline-variant/20 bg-transparent">
        <Button
          type="button"
          variant="ghost"
          size="sm"
