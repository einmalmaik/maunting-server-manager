...
def _admin_response(provider: AiProvider) -> AiProviderResponse:
    return AiProviderResponse(
        ...
        realtime_model=provider.realtime_model,
        realtime_voice=provider.realtime_voice,
        realtime_reasoning_effort=provider.realtime_reasoning_effort,
        realtime_language=provider.realtime_language,
        realtime_vad_eagerness=provider.realtime_vad_eagerness,
        realtime_text_input_price_micro_usd_per_million=provider.realtime_text_input_price_micro_usd_per_million,
