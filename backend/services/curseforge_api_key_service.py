...
Auflösung (ENV schlägt Panel):
    1. ``settings.curseforge_api_key`` / ``MSM_CURSEFORGE_API_KEY`` / ``CURSEFORGE_API_KEY``
    2. Panel-DB ``curseforge_api_key_enc`` (DIS-verschlüsselt, AAD ``msm:curseforge:api_key``)
    3. Legacy plain ``curseforge_api_key`` in panel_settings (Migration)
