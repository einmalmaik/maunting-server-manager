...
import { ServerCog, Mail, Loader2, ArrowLeft, CheckCircle } from 'lucide-react'
        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          {done ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Link to="/login" className="flex items-center justify-center gap-1 text-xs text-muted-foreground transition-colors hover:text-foreground">
