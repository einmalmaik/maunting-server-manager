 ...
 * wurde sie übersprungen, und weil `firmen-logo.png` noch nicht im Repo
 * liegt, bekam die mittlere Stufe nie jemand zu sehen. Eine Stufe, die
 * verschwindet, sieht aus wie ein Fehler im Ablauf; eine ohne Bild sagt
 * wenigstens, dass sie fehlt.
 */
...
export default function Splash({ onFertig }: { onFertig: () => void }) {
  ...
  // Der Aufrufer übergibt meist eine frisch gebaute Funktion. Haengt der
  // Stufentakt an ihrer Identitaet, startet er bei jedem Rendern des
  // Elternteils neu — und waehrend des Starts rendert das oft. Ueber die
  // Referenz haengt hier nur noch die Stufe.
